...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 50 }, { marker: 'pandoc', elapsed: 110 }, { marker: 'post-processor', elapsed: 10 }, { marker: 'pre-processor', elapsed: 20 }, { marker: 'render', elapsed: 720 } ];
